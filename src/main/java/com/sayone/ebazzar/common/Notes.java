...
public interface Notes {
   ...
   ;
   String USER_UPDATE="User can pass Authorization header and update user’s information such as first name, last name, phone number"
   ...
   ;
   String ADD_ADDRESS="Users can add an address on placing an order by passing the authorization header."
