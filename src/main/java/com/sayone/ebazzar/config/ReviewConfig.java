...
//            cartRepository.saveAll(List.of(cartEntity,cartEntity1));
            ...
            ProductEntity productEntity = new ProductEntity("Soap",150,"Lux Body Wash",10);
            ProductEntity productEntity1 = new ProductEntity("Mobile",50,"Redmi",10);
            ProductEntity productEntity2 = new ProductEntity("Laptop",30,"HP",10);
